...
async def on_help_command(message: Message, configs: Config, **kwargs) -> None:
    await message.edit(text=configs.HELP_TEXT, disable_web_page_preview=True)


async def on_start_command(client: Client, message: Message, configs: Config, **kwargs) -> None:
...
async def on_stop_command(message: Message, configs: Config, **kwargs) -> Message:
